...
// Set API key globally (check if the library requires this step)
...
export async function POST(req: Request) {
  try {
    ...
    // Use the correct model and make the call
    const result = await streamText({
      model: openai('gpt-3.5-turbo-instruct'), // No need to pass apiKey here
